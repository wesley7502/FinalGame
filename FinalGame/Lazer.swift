...
class Lazer: Enemy{
    ...
    init(lane: Int, scene: GameScene) {
        ...
        super.init(texture: texture, color: UIColor.clearColor(), size: CGSize(width: 53.33, height: 53.33), givenName: "lazer", points: 10, bd : 0.05, dif: 6, sp: 1, ty : "shooter", la: lane)
