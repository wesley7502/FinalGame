...
class Trapezoid: Enemy{
    ...
    init(lane: Int, scene: GameScene) {
        ...
        super.init(texture: texture, color: UIColor.clearColor(), size: CGSize(width: 106.66, height: 53.33), givenName: "trapezoid", points: 10, bd : 0.04, dif: 4,  sp: 2, ty : "shooter", la: lane)
